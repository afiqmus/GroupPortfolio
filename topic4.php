<?php 
    ...
    $result = $conn->query("SELECT * FROM topic4 "); 
?>
  ...
  <nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
      <li class="sidebar-brand">
        <a class="js-scroll-trigger">Topic 4</a>
      </li>
...
<section class="callout" id="overview">
    <div class="container text-center">
      <h1 class="mx-auto mb-5">Topic 4: Contract Review</h1>
...
-Difficulties in performing contract review 
-Contract review for internal projects</p>
   ...
   <section class="content-section bg-primary text-white text-center" id="mindmap">
    <div class="container">
      <div class="content-section-heading">
        <h3 class="text-secondary mb-0">Topic 4</h3>
      ...
      <div class="row">
        ...
        <?php while($row = $result->fetch_assoc()){ ?> 
          ...
          <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['mindmap4']); ?>" />   
          </span>
          <br>
          <hr>
          <button><a href="actionDelete4.php?Del=<?php echo $row['no'] ?>">Delete</a></button>
...
<hr>
      ...
      <br>
                    ...
                    <input id='mindmap4' class="form-control" name="mindmap4" type="file" multiple="multiple" required>
                    </div>
                        <input class="btn btn-warning btn-block text-white" type="submit" name="btnSub4" value="Submit">

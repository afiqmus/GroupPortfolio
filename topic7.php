<?php 
    ...
    $result = $conn->query("SELECT * FROM topic7 "); 
?>
  ...
  <nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
      <li class="sidebar-brand">
        <a class="js-scroll-trigger">Topic 7</a>
      </li>
   ...
   <section class="content-section bg-primary text-white text-center" id="mindmap">
    <div class="container">
      <div class="content-section-heading">
        <h3 class="text-secondary mb-0">Topic 7</h3>
      ...
      <div class="row">
        ...
        <?php while($row = $result->fetch_assoc()){ ?> 
          ...
          <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['mindmap7']); ?>" />   
          </span>
          <br>
          <hr>
          <button><a href="actionDelete7.php?Del=<?php echo $row['no'] ?>">Delete</a></button>
...
<hr>
      ...
      <br>
                    ...
                    <input id='mindmap7' class="form-control" name="mindmap7" type="file" multiple="multiple" required>
                    </div>
                        <input class="btn btn-warning btn-block text-white" type="submit" name="btnSub7" value="Submit">

<?php 
    ...
    $result = $conn->query("SELECT * FROM topic9 "); 
?>
  ...
  <nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
      <li class="sidebar-brand">
        <a class="js-scroll-trigger">Topic 9</a>
      </li>
...
<section class="callout" id="overview">
    <div class="container text-center">
      <h1 class="mx-auto mb-5">Topic 9: Software Maintanance</h1>
    
      <p>In this chapter, we will learn about :
-software maintenance component
- foundations of high quality
-pre-maintenance software quality components
-maintenance software quality assurance tools</p>
   ...
   <section class="content-section bg-primary text-white text-center" id="mindmap">
    <div class="container">
      <div class="content-section-heading">
        <h3 class="text-secondary mb-0">Topic 9</h3>
      ...
      <div class="row">
        ...
        <?php while($row = $result->fetch_assoc()){ ?> 
          ...
          <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['mindmap9']); ?>" />   
          </span>
          <br>
          <hr>
          <button><a href="actionDelete9.php?Del=<?php echo $row['no'] ?>">Delete</a></button>
...
<hr>
      ...
      <br>
                    ...
                    <input id='mindmap9' class="form-control" name="mindmap9" type="file" multiple="multiple" required>
                    </div>
                        <input class="btn btn-warning btn-block text-white" type="submit" name="btnSub9" value="Submit">
